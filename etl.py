'''
etl.py extracts data from the sources and loads it into the database
'''
...
def process_song_file(cur, filepath):
    '''
    Read data from song_data and append it into the tables : song_data, artist_data
    '''
    # open song file
...
def process_log_file(cur, filepath):
    '''
    Read data from log_data and append it into the tables : song_data, artist_data
    '''
    # open log file
    df = pd.read_json(filepath,  lines = True)
